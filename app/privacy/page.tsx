            ...
            <div className="max-w-3xl mx-auto">
                ...
                <div className="space-y-8 text-neutral-300 leading-relaxed">
                    <section>
                        ...
                        <p>
                            Bijdehand, gemaakt door Misha Scholte, is gebouwd op een simpel principe:
                            jouw klantenpassen zijn jouw zaak, niet de mijne. Ik geloof dat je privacy niet hoeft op te geven voor gemak.
                        </p>
                    </section>

                    <section>
                        <h2 className="text-xl font-semibold text-white mb-3">2. Gegevensverzameling & Tracking</h2>
                        <p className="mb-2">Ik verzamel geen persoonlijke gegevens.</p>
                    ...
                    <section>
                        ...
                        <ol className="list-decimal pl-5 space-y-1 mt-2 text-neutral-400">
                            ...
                            <li>In je persoonlijke iCloud, via CloudKit. Deze gegevens zijn versleuteld door Apple en alleen toegankelijk voor jou. Ik, de ontwikkelaar, heb geen toegang tot jouw iCloud-gegevens.</li>
                        </ol>
                    </section>

                    <section>
                        <h2 className="text-xl font-semibold text-white mb-3">4. Apple Wallet Integratie</h2>
                        <p className="mb-2">Om de functie "Toevoegen aan Apple Wallet" mogelijk te maken, gebeurt er een specifieke, beperkte serverhandeling:</p>
                        <ul className="list-disc pl-5 space-y-2 text-neutral-400">
                            ...
                            <li><span className="text-white">Verwerker:</span> Scaleway, een hostingprovider gevestigd in Parijs, Frankrijk (AVG/GDPR compliant).</li>
                            <li><span className="text-white">Bewaartermijn:</span> Deze gegevens worden in het geheugen verwerkt om de pas te genereren en daarna onmiddellijk verwijderd. Ik log of bewaar je kaartgegevens niet.</li>
                        </ul>
                    </section>

                    <section>
                        <h2 className="text-xl font-semibold text-white mb-3">5. Diensten van derden</h2>
                        <p className="mb-2">Ik gebruik de volgende minimale diensten om de app te laten werken:</p>
                        <ul className="list-disc pl-5 space-y-1 text-neutral-400">
                    ...
                    <section>
                        ...
                        <p>
                            Omdat ik geen gegevens van je bewaar, kan ik je account niet verwijderen. Het bestaat immers niet.
